...
<div>
    <p>Allow the project lead and volunteers to add a comment on the milestone posted by the project lead</p>
        ...
        <div></div>
        <h5>Url: <a href="https://ashesicivicengagement-dev.herokuapp.com/civicdoc/project/milestone/comment/new?mId=" target="_blank">https://ashesicivicengagement-dev.herokuapp.com/civicdoc/project/milestone/comment/new?mId=[milestoneId]</b></a></h5>
