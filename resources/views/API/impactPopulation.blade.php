...
<div>
    <p>Disp
        ...
        <div></div>
        <h5>Url: <a href="https://ashesicivicengagement-dev.herokuapp.com/civicdoc/project/impactpopulation/retrieve?pId=" target="_blank"> https://ashesicivicengagement-dev.herokuapp.com/civicdoc/project/impactpopulation/retrieve?pId=[projectId]</b></a> </h5>
        ...
        <code>
         ...
         <samp style="margin-left: 120px;color:black">"impactPopulation": [</samp><br>
