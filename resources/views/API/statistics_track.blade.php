...
<div>
    ...
    <ul>
        ...
        <li>track i.e <b>id=population <i style="color:green">to display the target population cumulative values</i></i><i style="color: blue">volunteer to display the volunteer track over time</i></li>
    </ul>
