    ...
    <form class="form-horizontal" method="POST" action="/civicdoc/attachrole/new">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="citizenship" name="citizenship" value="{!! $citizenship !!}" type="text" placeholder="" disabled="true"  class="form-control input-md">  
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="region" name="region" disabled="true"  type="text" value="{!! $region !!}" placeholder="" class="form-control input-md">
