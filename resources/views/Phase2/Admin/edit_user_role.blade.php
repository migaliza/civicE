    ...
    <form class="form-horizontal" method="POST" action="civicdoc/attachrole/new">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="fName" name="fName" value="{!! $fName !!}" type="text" placeholder="" class="form-control input-md" disabled="true">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="lName" name="lName" value="{!! $lName !!}" type="text" placeholder="" class="form-control input-md" disabled="true">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="citizenship" name="citizenship" value="{!! $citizenship !!}" type="text" placeholder=""  class="form-control input-md" disabled="true">  
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="region" name="region"   type="text" value="{!! $region !!}" placeholder="" class="form-control input-md" disabled="true">
